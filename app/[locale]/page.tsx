...
export default function HomeScreen() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-6 bg-white dark:bg-gray-900">
      <h1 className="text-3xl font-bold text-gray-900 dark:text-white text-center" style={{ direction: rtl ? 'rtl' : 'ltr' }}>
        {t("app_name")}
      </h1>
      <p className="mt-4 text-lg text-gray-600 dark:text-gray-400 text-center" style={{ direction: rtl ? 'rtl' : 'ltr' }}>
        {t("app_subtitle")}
      </p>
      <div className={`mt-8 flex ${rtl ? 'flex-row-reverse space-x-reverse' : 'space-x-4'}`}>
